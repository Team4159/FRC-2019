...
public class CameraThread extends Thread {
    ...
    private CameraThread() {
        ...
        video1 = CameraServer.getInstance().startAutomaticCapture("Hatch Cam", 0);
        video2 = CameraServer.getInstance().startAutomaticCapture("Cargo Cam", 1);
        ...
        cvSource = CameraServer.getInstance().putVideo("Driver Cam", 320, 240);
